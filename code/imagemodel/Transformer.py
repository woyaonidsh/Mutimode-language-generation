...
for i in range(20):
    data.append(i)
src = torch.tensor(data).view(1,20).cuda()
tgt = src
...
image = torch.randn(1,20,128).cuda()
model = make_model(50256 ,50256 , 6 , d_model=128 , d_ff=1024).cuda()

ouptut = model.forward(src , tgt , src_mask ,tgt_mask ,image=image )
print(ouptut.shape)
"""
